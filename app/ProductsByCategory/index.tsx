...
import { getAllProductsByCategory } from "../../src/api/helper";
...
const ProductsByCateogry = () => {
  ...
  const HEADER_TITLE = paramItem["title"] as string;
  ...
  const fetchAllProducts = async (isRefresh?: any) => {
    ...
    getAllProductsByCategory(paramItem["id"], isRefresh ? 1 : page).then(
      (response) => {
...
export default ProductsByCateogry;
